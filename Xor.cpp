...
Xor::Xor(Common com, queue<short> &instruction, map<string, int> &registers, map<string, int> &memories32bit, map<string, int16_t> &memories16bit, map<string, int8_t> &memories8bit, list<string> &memoryAccesses, ofstream &myoutput)
...
string Xor::decode_displacement_with_SIB(int w, int d, int mod, int reg, int index, int scale, int base)
{
    string dispWithSIB = "";
        ...
        if (base == 5)
        {
            if (w == 0)
            {
                if (d == 0)
                {
                    if (index == 4)
                    {
                        memoryAccesses.push_back("xor %" + regs_8[reg] + "," + st);
                    ...
                    {
                        memoryAccesses.push_back("xor %" + regs_8[reg] + "," + st + "(,%" + regs_32[index] + "," + to_string(scale) + ")");
            ...
            else if (w == 1)
            {
                if (opSize)
                {
                    if (d == 0)
                    {
                        if (index == 4)
                        {
                            memoryAccesses.push_back("xor " + st + ",%" + regs_16[reg]);
                        ...
                        {
                            memoryAccesses.push_back("xor " + st + "(,%" + regs_32[index] + "," + to_string(scale) + "),%" + regs_16[reg]);
                ...
                else
                {
                    if (d == 0)
                    {
                        if (index == 4)
                        {
                            memoryAccesses.push_back("xor " + st + ",%" + regs_32[reg]);
                        ...
                        {
                            memoryAccesses.push_back("xor " + st + "(,%" + regs_32[index] + "," + to_string(scale) + "),%" + regs_32[reg]);
        ...
        else
        {
            if (w == 0)
            {
                if (d == 0)
                {
                    ...
                    {
                        memoryAccesses.push_back("xor (%" + regs_32[base] + ",%" + regs_32[index] + "," + to_string(scale) + "),%" + regs_8[reg]);
            ...
            else if (w == 1)
            {
                if (opSize)
                {
                    if (d == 0)
                    {
                        if (index == 4)
                        {
                            memoryAccesses.push_back("xor (%" + regs_32[base] + "),%" + regs_16[reg]);
                        ...
                        {
                            memoryAccesses.push_back("xor (%" + regs_32[base] + ",%" + regs_32[index] + "," + to_string(scale) + "),%" + regs_16[reg]);
                ...
                else
                {
                    if (d == 0)
                    {
                        if (index == 4)
                        {
                            memoryAccesses.push_back("xor (%" + regs_32[base] + ")" + ",%" + regs_32[reg]);
                        ...
                        {
                            memoryAccesses.push_back("xor (%" + regs_32[base] + ",%" + regs_32[index] + "," + to_string(scale) + "),%" + regs_32[reg]);
    ...
    else
    {
        ...
        if (w == 0)
        {
            if (d == 0)
            {
                if (index == 4)
                {
                    memoryAccesses.push_back("xor " + st + "(%" + regs_32[base] + "),%" + regs_8[reg]);
                ...
                {
                    memoryAccesses.push_back("xor " + st + "(%" + regs_32[base] + ",%" + regs_32[index] + "," + to_string(scale) + "),%" + regs_8[reg]);
        ...
        else if (w == 1)
        {
            if (opSize)
            {
                if (d == 0)
                {
                    if (index == 4)
                    {
                        memoryAccesses.push_back("xor " + st + "(%" + regs_32[base] + "),%" + regs_16[reg]);
                    ...
                    {
                        memoryAccesses.push_back("xor " + st + "(%" + regs_32[base] + ",%" + regs_32[index] + "," + to_string(scale) + "),%" + regs_16[reg]);
            ...
            else
            {
                if (d == 0)
                {
                    if (index == 4)
                    {
                        memoryAccesses.push_back("xor " + st + "(%" + regs_32[base] + ")" + ",%" + regs_32[reg]);
                    ...
                    {
                        memoryAccesses.push_back("xor " + st + "(%" + regs_32[base] + ",%" + regs_32[index] + "," + to_string(scale) + "),%" + regs_32[reg]);
...
string Xor::decode_displacement_without_SIB(int w, int d, int mod, int reg, int rm)
{
    ...
    if (mod == 0)
    {
        if (w == 0)
        {
            if (d == 0)
            {
                memoryAccesses.push_back("xor " + st + ",%" + regs_8[reg]);
    ...
    else
    {
        if (w == 0)
        {
            if (d == 0)
            {
                memoryAccesses.push_back("xor " + st + "(%" + regs_32[rm] + "),%" + regs_8[reg]);
        ...
        else if (w == 1)
        {
            if (opSize)
            {
                if (d == 0)
                {
                    memoryAccesses.push_back("xor " + st + "(%" + regs_32[rm] + "),%" + regs_16[reg]);
...
string Xor::decode_SIB(int w, int d, int mod, int reg)
{
    string stringSib = "";
...
string Xor::decode_mod_00(int w, int d, int reg, int rm)
{
    string string00 = "";
    if (rm == 4)
    {
    ...
    else
    {
        if (w == 0)
        {
            if (d == 0)
            {
                memoryAccesses.push_back("xor (%" + regs_32[rm] + "),%" + regs_8[reg]);
        ...
        else if (w == 1)
        {
            if (opSize)
            {
                if (d == 0)
                {
                    memoryAccesses.push_back("xor (%" + regs_32[rm] + "),%" + regs_16[reg]);
            ...
            else
            {
                if (d == 0)
                {
                    memoryAccesses.push_back("xor (%" + regs_32[rm] + "),%" + regs_32[reg]);
...
string Xor::decode_mod_01(int w, int d, int reg, int rm)
{
    string string01 = "";
    if (rm == 4)
    {
...
string Xor::decode_mod_10(int w, int d, int reg, int rm)
{
    string string10 = "";
    if (rm == 4)
    {
...
string Xor::decode_mod_11(int w, int d, int reg, int rm)
{
    string string11 = "";
    if (w == 0)
    {
...
string Xor::decode_imm(int opCode, int w, int d)
{
    string dec_imm;
    int imm;
...
string Xor::decode_xor(short prefixes[4])
{
    string decoded_bytes;

    if (prefixes[3] == 0x67)
    {
        Xor_xorOverride Xor_xorOverride(common, instruction, registers, memories32bit, memories16bit, memories8bit, memoryAccesses);
        decoded_bytes = Xor_xorOverride.decode_xor(prefixes);
    }
    else
    {
        ...
        else
        {
            ...
            if (immediate)
            {
                Xor_immediate xor_immediate(common, instruction, registers, memories32bit, memories16bit, memories8bit, memoryAccesses);
                decoded_bytes = xor_immediate.decode_imm(prefixes, w, d, mod, rm);
            }
            else
            {
                if (mod == 0)
    ...
    return "xor instantiated and done";
}
