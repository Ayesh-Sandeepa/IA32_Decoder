...
string And_immediate::decode_displacement_with_SIB(int w, int mod, int index, int scale, int base)
{
    string dispWithSIB = "";
...
string And_immediate::decode_displacement_without_SIB(int w, int mod, int rm)
{
...
string And_immediate::decode_SIB(int w, int mod)
{
    string stringSib = "";
...
string And_immediate::decode_mod_00(int w, int rm)
{
    string string00 = "";
    if (rm == 4)
    {
...
string And_immediate::decode_mod_01(int w, int rm)
{
    string string01 = "";
    if (rm == 4)
    {
...
string And_immediate::decode_mod_10(int w, int rm)
{
    string string10 = "";
    if (rm == 4)
    {
...
string And_immediate::decode_mod_11(int w, int rm)
{
    string string11 = "";
    if (w == 0)
    {
...
string And_immediate::decode_imm(short prefixes[4], int w, int mod, int rm)
{
