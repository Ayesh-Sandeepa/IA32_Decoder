...
Left_shift_immediate::Left_shift_immediate(Common com, queue<short> &instruction, map<string, int> &registers, map<string, int> &memories32bit, map<string, int16_t> &memories16bit, map<string, int8_t> &memories8bit, list<string> &memoryAccesses)
...
string Left_shift_immediate::decode_displacement_with_SIB(int w, int mod, int index, int scale, int base)
{
    string dispWithSIB = "";
        ...
        if (base == 5)
        {
            if (w == 0)
            {
                ...
                if (index == 4)
                {
                    ...
                    memoryAccesses.push_back("shl " +st + ", $" + common.getHex(unmaskedImm, 0, 0));
                ...
                else
                {
                    ...
                    memoryAccesses.push_back("shl " + st + "(,%" + regs_32[index] + "," + to_string(scale) + "), $" + common.getHex(unmaskedImm, 0, 0) );
        ...
        else
        {
            ...
            {                
                if (index == 4)
                {
                    ...
                    memoryAccesses.push_back("shl (%" + regs_32[base] + "), $" + common.getHex(unmaskedImm, 0, 0));
                ...
                else
                {
                    ...
                    memoryAccesses.push_back("shl (%" + regs_32[base] + ",%" + regs_32[index] + "," + to_string(scale) + ")" + "$" + common.getHex(unmaskedImm, 0, 0));
    ...
    else
    {
        ...
        {           
            if (index == 4)
            {
                ...
                memoryAccesses.push_back("shl " +st + "(%" + regs_32[base] + ")" + ", $" + common.getHex(unmaskedImm, 0, 0));
            ...
            else
            {
                ...
                memoryAccesses.push_back("shl " + st + "(%" + regs_32[base] + ",%" + regs_32[index] + "," + to_string(scale) + ")" + ", $" + common.getHex(unmaskedImm, 0, 0));
...
string Left_shift_immediate::decode_displacement_without_SIB(int w, int mod, int rm)
{
    ...
    else
    {
        if (w == 0)
        {
            ...
            memoryAccesses.push_back("shl " + st + "(%" + regs_32[rm] + ")"+", $" + common.getHex(unmaskedImm, 0, 0));
...
string Left_shift_immediate::decode_SIB(int w, int mod)
{
    string stringSib = "";
...
string Left_shift_immediate::decode_mod_00(int w, int rm)
{
    string string00 = "";
    if (rm == 4)
    {
    ...
    else
    {
        ...
        if (w == 0)
        {
            ...
            memoryAccesses.push_back("shl (%" + regs_32[rm] + "), $" + common.getHex(unmaskedImm, 0, 0));
...
string Left_shift_immediate::decode_mod_01(int w, int rm)
{
    string string01 = "";
    if (rm == 4)
    {
...
string Left_shift_immediate::decode_mod_10(int w, int rm)
{
    string string10 = "";
    if (rm == 4)
    {
...
string Left_shift_immediate::decode_mod_11(int w, int rm)
{
    int8_t unmaskedImm = common.assemble_bits(1, instruction, registers);
    int imm = common.get_bits(1, 5, unmaskedImm);
...
string Left_shift_immediate::decode_shl(short prefixes[4])
{
    ...
    if (prefixes[3] == 0x67)
    {
        ...
        if (reg == 5)
        {
            Right_shift_immediate Right_shift_immediate(common, instruction, registers, memories32bit, memories16bit, memories8bit, memoryAccesses);
            decoded_bytes = Right_shift_immediate.decode_shr(prefixes, w, mod, rm);
            return decoded_bytes;
        }
        else
        {
