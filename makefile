...
main: main.o common.o adder.o adder_addOverride.o immediate.o immediate_addOverride.o bitset.o bitset_addOverride.o mov.o mov_immediate.o mov_override.o mov_override_immediate.o And.o and_immediate.o andOverride.o and_override_immediate.o Cmp.o cmp_immediate.o cmpOverride.o cmp_override_immediate.o Or.o or_immediate.o orOverride.o or_override_immediate.o Xor.o xor_immediate.o xorOverride.o xor_override_immediate.o mul.o mul.o inc.o inc_override.o dec.o dec_override.o left_shift.o left_shift_override.o right_shift.o right_shift_override.o left_shift_override_immediate.o right_shift_override_immediate.o divider.o divider_addOverride.o not.o not_addOverride.o
