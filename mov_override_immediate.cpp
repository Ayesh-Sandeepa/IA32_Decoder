...
Mov_override_immediate::Mov_override_immediate(Common com, queue<short> &instruction, map<string, int> &registers, map<string, int> &memories32bit, map<string, int16_t> &memories16bit, map<string, int8_t> &memories8bit, list<string> &memoryAccesses)
...
string Mov_override_immediate::decode_displacement_without_SIB(int w, int mod, int rm)
{
...
string Mov_override_immediate::decode_mod_00(int w, int rm)
{
    string string00 = "";
    if (rm == 6)
    {
...
string Mov_override_immediate::decode_mod_01(int w, int rm)
{
    string string01 = decode_displacement_without_SIB(w, 1, rm);
    return string01;
}

string Mov_override_immediate::decode_mod_10(int w, int rm)
{
    string string10 = decode_displacement_without_SIB(w, 2, rm);
    return string10;
}

string Mov_override_immediate::decode_mod_11(int w, int rm)
{
    string string11 = "";
    if (w == 0)
    {
...
string Mov_override_immediate::decode_imm(short prefixes[4], int w, int mod, int rm)
{
