...
Or_immediate::Or_immediate(Common com, queue<short> &instruction, map<string, int> &registers, map<string, int> &memories32bit, map<string, int16_t> &memories16bit, map<string, int8_t> &memories8bit, list<string> &memoryAccesses)
...
string Or_immediate::decode_displacement_with_SIB(int w, int s, int mod, int index, int scale, int base)
{
    string dispWithSIB = "";
    ...
    if (mod == 0)
    {
        if (base == 5)
        {
            if (w == 0)
            {
                ...
                if (index == 4)
                {
                    memoryAccesses.push_back("or " +st + ", $" + common.getHex(num1, 0, 0));
                ...
                {
                    memoryAccesses.push_back("or " + st + "(,%" + regs_32[index] + "," + to_string(scale) + "), $" + common.getHex(num1, 0, 0) );
            ...
            else if (w == 1)
            {
                ...
                else
                {
                    if (s == 0)
                    {
                        ...
                        if (index == 4)
                        {
                            memoryAccesses.push_back("or " + st + ", $" + common.getHex(num2, 0, 0));
                        ...
                        {
                            memoryAccesses.push_back("or " + st + "(,%" + regs_32[index] + "," + to_string(scale) + "), $" + common.getHex(num2, 0, 0));
        ...
        else
        {
            if (w == 0)
            {
                ...
                if (index == 4)
                {
                    memoryAccesses.push_back("or (%" + regs_32[base] + "), $" + common.getHex(num1, 0, 0));
                ...
                {
                    memoryAccesses.push_back("or (%" + regs_32[base] + ",%" + regs_32[index] + "," + to_string(scale) + ")" + "$" + common.getHex(num1, 0, 0));
            ...
            else if (w == 1)
            {
                ...
                else
                {
                    if (s == 0)
                    {
                        ...
                        if (index == 4)
                        {
                            memoryAccesses.push_back("or (%" + regs_32[base] + ")" +", $" + common.getHex(num2, 0, 0) );
                        ...
                        {
                            memoryAccesses.push_back("or (%" + regs_32[base] + ",%" + regs_32[index] + "," + to_string(scale) + ")" + "$" + common.getHex(num2, 0, 0));
    ...
    else
    {
        ...
        if (w == 0)
        {
            ...
            if (index == 4)
            {
                memoryAccesses.push_back("or " +st + "(%" + regs_32[base] + ")" + ", $" + common.getHex(num1, 0, 0));
            ...
            {
                memoryAccesses.push_back("or " + st + "(%" + regs_32[base] + ",%" + regs_32[index] + "," + to_string(scale) + ")" + ", $" + common.getHex(num1, 0, 0));
        ...
        else if (w == 1)
        {
            ...
            else
            {
                if (s == 0)
                {
                    ...
                    if (index == 4)
                    {
                        memoryAccesses.push_back("or " + st + "(%" + regs_32[base] + ")" + ", $" + common.getHex(num2, 0, 0));
                    ...
                    {
                        memoryAccesses.push_back("or " +  st + "(%" + regs_32[base] + ",%" + regs_32[index] + "," + to_string(scale) + ")" + ", $" + common.getHex(num2, 0, 0));
...
string Or_immediate::decode_displacement_without_SIB(int w, int s, int mod, int rm)
{
        ...
        else if (w == 1)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    memoryAccesses.push_back("or " + st + ", $" + common.getHex(num, 8, 'f') );
                    memoryAccesses.push_back("Read " + to_string(num1) + " from " + st);
    ...
    else
    {
        ...
        {
            int8_t num1 = common.assemble_bits(1, instruction, registers);
            memoryAccesses.push_back("or " + st + "(%" + regs_32[rm] + ")"+", $" + common.getHex(num1, 0, 0));
        ...
        else if (w == 1)
        {
            if (opSize)
            {
                ...
                else if (s == 1)
                {
                    ...
                    memoryAccesses.push_back("or " + st + "(%" + regs_32[rm] + ")" + ", $" + common.getHex(num, 4, 'f'));
...
string Or_immediate::decode_SIB(int w, int s, int mod)
{
    string stringSib = "";
...
string Or_immediate::decode_mod_00(int w, int s, int rm)
{
    string string00 = "";
    if (rm == 4)
    {
    ...
    else
    {
        ...
        {
            int8_t num1 = common.assemble_bits(1, instruction, registers);
            memoryAccesses.push_back("or (%" + regs_32[rm] + "), $" + common.getHex(num1, 0, 0));
        ...
        else if (w == 1)
        {
            ...
            else
            {
                ...
                {
                    int num2 = common.assemble_bits(4, instruction, registers);
                    memoryAccesses.push_back("or (%" + regs_32[rm] + "), $" + common.getHex(num2, 0, 0));
...
string Or_immediate::decode_mod_01(int w, int s, int rm)
{
    string string01 = "";
    if (rm == 4)
    {
...
string Or_immediate::decode_mod_10(int w, int s, int rm)
{
    string string10 = "";
    if (rm == 4)
    {
...
string Or_immediate::decode_mod_11(int w, int s, int rm)
{
    string string11 = "";
    if (w == 0)
    {
...
string Or_immediate::decode_imm(short prefixes[4], int w, int s, int mod, int rm)
{
